...
class LocalizerZH:
    ...
    cagecsv_encoding_error_log: str = "CSV 文件因编码问题跳过输出: {FILE} …"
    cagecsv_encoding_error_toast: str = "以下 CSV 文件含有原始编码不支持的字符，已跳过输出，请修正译文中的特殊字符后重新生成: {FILES} …"
    cagecsv_encoding_error_and_more: str = " 等另 {N} 个文件"
    ...
    proofreading_page_retranslate_with_context: str = "携带上文重新翻译"
    proofreading_page_retranslate_with_context_confirm: str = "确定携带上文重新翻译此条目？"
    proofreading_page_batch_retranslate: str = "重新翻译已选条目"
    proofreading_page_batch_retranslate_confirm: str = "确定重新翻译全部 {COUNT} 个条目？"
    proofreading_page_batch_retranslate_with_context: str = "携带上文重新翻译已选条目"
    ...
    workbench_col_modified: str = "最后修改"
    ...
    expert_settings_page_preceding_context_mode: str = "参考上文内容模式"
    expert_settings_page_preceding_context_mode_desc: str = "设置参考上文时使用的内容类型"
    expert_settings_page_preceding_context_mode_button: str = "选择模式"
    expert_settings_page_preceding_context_mode_original: str = "使用原文作为参考上文"
    expert_settings_page_preceding_context_mode_translated: str = "使用译文作为参考上文"
    expert_settings_page_preceding_context_mode_both: str = "同时使用原文与译文作为参考上文"
    ...
    expert_settings_page_review_model: str = "AI 审校模型"
    expert_settings_page_review_model_desc: str = "选择用于 AI 审校的模型，留空则使用当前激活模型"
    expert_settings_page_review_approval_mode: str = "AI 审校审批模式"
    expert_settings_page_review_approval_mode_desc: str = "选择 AI 审校建议的处理方式"
    expert_settings_page_review_preceding_lines: str = "AI 审校上文行数"
    expert_settings_page_review_preceding_lines_desc: str = "AI 审校时提供给 AI 的上文行数，用于保证上下文一致性"
    expert_settings_page_review_timeout: str = "AI 审校单行超时（秒）"
    expert_settings_page_review_timeout_desc: str = "单行 AI 审校请求的超时时间"
    ...
    # AI 审校
    app_review_page: str = "AI 审校"
    review_page_desc: str = "使用 AI 审校翻译质量，检查一致性、准确性和术语使用"
    review_page_start: str = "开始审校"
    review_page_stop: str = "停止审校"
    review_page_model: str = "审校模型"
    review_page_model_desc: str = "选择用于审校的模型，留空则使用当前激活模型"
    review_page_approval_mode: str = "审批模式"
    review_page_approval_mode_desc: str = "选择 AI 审校建议的处理方式"
    review_page_approval_manual: str = "手动审批"
    review_page_approval_auto: str = "自动接受"
    review_page_approval_auto_skip: str = "自动（失败时暂停）"
    review_page_preceding_lines: str = "上文行数"
    review_page_preceding_lines_desc: str = "审校时提供给 AI 的上文行数，用于保证上下文一致性"
    review_page_timeout: str = "单行超时（秒）"
    review_page_timeout_desc: str = "单行审校请求的超时时间"
    ...
    review_page_capture_video: str = "视频（无音频）"
    review_page_capture_video_audio: str = "视频（含音频）"
    review_page_capture_audio: str = "音频"
    review_page_capture_window: str = "游戏窗口标题"
    review_page_capture_window_desc: str = "要捕获的游戏窗口标题，可手动输入或从运行中的程序选择"
    review_page_capture_window_select: str = "选择窗口"
    review_page_capture_window_none: str = "未找到可见窗口"
    ...
    review_page_error: str = "审校出错"
    review_page_status_idle: str = "空闲"
    review_page_status_reviewing: str = "审校中"
    review_page_status_stopping: str = "停止中"
    review_page_line_pass: str = "通过"
    review_page_line_fix: str = "已修正"
    review_page_line_fail: str = "失败"
    review_page_line_pending: str = "待审"
    review_page_line_error: str = "出错"
    review_page_awaiting: str = "等待审批 …"
    review_page_result_reason: str = "原因"
    review_page_approve: str = "通过"
    review_page_skip: str = "跳过"
    ...
    review_page_starting_line_select: str = "选择行 …"
    review_page_starting_line_selected: str = "第 {LINE} 行"
    review_page_starting_line_from_beginning: str = "从头开始"
    review_page_inquiry_placeholder: str = "输入你的问题 …"
    review_page_inquiry_send: str = "发送"
    review_page_inquiry_question: str = "Q: {TEXT}"
    review_page_inquiry_answer: str = "A: {TEXT}"
    review_page_continue: str = "继续审校"
    review_page_reset: str = "重置"
    review_page_reset_tooltip: str = "重置审校会话进度"
    review_page_reset_failed: str = "重置失败行"
    review_page_reset_all: str = "重置全部"
    review_page_alert_reset_failed: str = "将把出错行移回待审校队列，是否继续？"
    review_page_alert_reset_all: str = "将清空当前审校会话，是否继续？"
    review_page_export_report: str = "导出审校报告"
    review_page_export_report_desc: str = "审校完成后导出详细报告"
    review_page_export_report_path: str = "报告导出路径"
    review_page_export_report_path_desc: str = "留空则导出到应用根目录"
    review_page_rate_limit: str = "频率限制"
    review_page_rate_limit_desc: str = "每分钟 API 调用次数限制，0 为不限制"
    review_page_custom_prompt: str = "自定义审校提示词"
    review_page_glossary_review: str = "术语表审校"
    review_page_glossary_review_desc: str = "使用 AI 审查术语表条目的准确性"
    review_page_glossary_review_start: str = "开始术语表审校"
    review_page_glossary_review_batch_size: str = "每批条目数"
    review_page_glossary_review_batch_size_desc: str = "术语表审校每次发送给 AI 的条目数量"
    review_page_glossary_review_undo: str = "撤销变更"
    review_page_glossary_review_confirm: str = "确认变更"
    review_page_glossary_review_progress: str = "正在审校术语表，第 {CURRENT} 批，共 {TOTAL} 批 …"
    glossary_review_action: str = "AI 审校"
    glossary_review_all: str = "审校全部条目"
    glossary_review_selected: str = "审校选中条目"
    glossary_review_no_entries: str = "没有可审校的术语条目"
    glossary_review_no_selection: str = "未选中任何条目"
    glossary_review_done: str = "术语表审校完成"
    glossary_review_results_title: str = "术语表审校结果"
    glossary_review_keep: str = "保留"
    glossary_review_fix: str = "修正"
    glossary_review_remove: str = "移除"
    glossary_review_apply: str = "应用变更"
    glossary_review_discard: str = "放弃"
    glossary_review_applied: str = "术语表审校变更已应用"
    review_page_history: str = "历史"
    review_page_history_undo: str = "撤销"
    review_page_history_redo: str = "重做"
    review_page_history_save: str = "保存"
    review_page_history_empty: str = "暂无已审校行"
    review_page_history_undo_success: str = "已还原译文以待重新审校"
    review_page_history_redo_success: str = "已重新应用译文修正"
    review_page_history_save_success: str = "已保存 {COUNT} 行到项目"
    review_page_filter_all: str = "全部"
    review_page_filter_pass: str = "通过"
    review_page_filter_fix: str = "已修正"
    review_page_filter_fail: str = "失败"
    review_page_filter_error: str = "出错"
