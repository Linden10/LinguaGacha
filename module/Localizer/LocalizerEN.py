...
class LocalizerEN(LocalizerZH):
    ...
    table_col_modified: str = "Modified"
    ...
    cagecsv_encoding_error_log: str = "CSV file skipped due to encoding error: {FILE} …"
    cagecsv_encoding_error_toast: str = "The following CSV files contain characters unsupported by the original encoding and were skipped. Please correct the special characters in your translations and regenerate: {FILES} …"
    cagecsv_encoding_error_and_more: str = " and {N} more"
    ...
    proofreading_page_retranslate_with_context: str = "Retranslate with context"
    proofreading_page_retranslate_with_context_confirm: str = "Retranslate this entry with preceding context?"
    ...
    proofreading_page_batch_retranslate_with_context: str = "Retranslate selected with context"
    ...
    workbench_col_modified: str = "Last Modified"
    ...
    expert_settings_page_preceding_context_mode: str = "Preceding Context Mode"
    expert_settings_page_preceding_context_mode_desc: str = "Choose what content to use as preceding context"
    expert_settings_page_preceding_context_mode_button: str = "Select Mode"
    expert_settings_page_preceding_context_mode_original: str = "Use original (untranslated) lines as context"
    expert_settings_page_preceding_context_mode_translated: str = "Use translated lines as context"
    expert_settings_page_preceding_context_mode_both: str = "Use both original and translated lines as context"
    ...
    expert_settings_page_review_model: str = "AI Review Model"
    expert_settings_page_review_model_desc: str = "Select the model used for AI review, leave empty to use the currently active model"
    expert_settings_page_review_approval_mode: str = "AI Review Approval Mode"
    expert_settings_page_review_approval_mode_desc: str = "Choose how AI review suggestions are handled"
    expert_settings_page_review_preceding_lines: str = "AI Review Preceding Lines"
    expert_settings_page_review_preceding_lines_desc: str = "Number of preceding lines to provide to AI for context consistency during review"
    expert_settings_page_review_timeout: str = "AI Review Per-Line Timeout (seconds)"
    expert_settings_page_review_timeout_desc: str = "Timeout for each AI review request"
    ...
    # AI Review
    app_review_page: str = "AI Review"
    review_page_desc: str = "Use AI to review translation quality, checking consistency, accuracy, and glossary usage"
    review_page_start: str = "Start Review"
    review_page_stop: str = "Stop Review"
    review_page_model: str = "Review Model"
    review_page_model_desc: str = "Select the model used for review, leave empty to use the currently active model"
    review_page_approval_mode: str = "Approval Mode"
    review_page_approval_mode_desc: str = "Choose how AI review suggestions are handled"
    review_page_approval_manual: str = "Manual Approval"
    review_page_approval_auto: str = "Auto Accept"
    review_page_approval_auto_skip: str = "Auto (Pause on Fail)"
    review_page_preceding_lines: str = "Preceding Lines"
    review_page_preceding_lines_desc: str = "Number of preceding lines to provide to AI for context consistency"
    ...
    review_page_capture_window_desc: str = "Title of the game window to capture; type manually or select from running programs"
    review_page_capture_window_select: str = "Select Window"
    review_page_capture_window_none: str = "No visible windows found"
    ...
    review_page_error: str = "Review Error"
    review_page_status_idle: str = "Idle"
    review_page_status_reviewing: str = "Reviewing"
    review_page_status_stopping: str = "Stopping"
    review_page_line_pass: str = "Pass"
    review_page_line_fix: str = "Fixed"
    review_page_line_fail: str = "Fail"
    review_page_line_pending: str = "Pending"
    review_page_line_error: str = "Error"
    review_page_awaiting: str = "Awaiting approval …"
    review_page_result_reason: str = "Reason"
    review_page_approve: str = "Approve"
    review_page_skip: str = "Skip"
    ...
    review_page_starting_line_select: str = "Select Line …"
    review_page_starting_line_selected: str = "Line {LINE}"
    review_page_starting_line_from_beginning: str = "From Beginning"
    review_page_inquiry_placeholder: str = "Type your question …"
    review_page_inquiry_send: str = "Send"
    review_page_inquiry_question: str = "Q: {TEXT}"
    review_page_inquiry_answer: str = "A: {TEXT}"
    review_page_continue: str = "Continue Review"
    review_page_reset: str = "Reset"
    review_page_reset_tooltip: str = "Reset review session progress"
    review_page_reset_failed: str = "Reset Failed Lines"
    review_page_reset_all: str = "Reset All Lines"
    review_page_alert_reset_failed: str = "This will move error lines back to the review queue. Continue?"
    review_page_alert_reset_all: str = "This will clear the entire review session. Continue?"
    review_page_export_report: str = "Export Review Report"
    review_page_export_report_desc: str = "Export a detailed report after review"
    review_page_export_report_path: str = "Report Export Path"
    review_page_export_report_path_desc: str = "Leave empty to export to the application root directory"
    review_page_rate_limit: str = "Rate Limit"
    review_page_rate_limit_desc: str = "API calls per minute limit, 0 for unlimited"
    review_page_custom_prompt: str = "Custom Review Prompt"
    review_page_glossary_review: str = "Glossary Review"
    review_page_glossary_review_desc: str = "Use AI to review glossary entries for accuracy"
    review_page_glossary_review_start: str = "Start Glossary Review"
    review_page_glossary_review_batch_size: str = "Batch Size"
    review_page_glossary_review_batch_size_desc: str = "Number of glossary entries sent to AI per batch"
    review_page_glossary_review_undo: str = "Undo Changes"
    review_page_glossary_review_confirm: str = "Confirm Changes"
    review_page_glossary_review_progress: str = "Reviewing glossary, batch {CURRENT} of {TOTAL} …"
    glossary_review_action: str = "AI Review"
    glossary_review_all: str = "Review All Entries"
    glossary_review_selected: str = "Review Selected Entries"
    glossary_review_no_entries: str = "No glossary entries to review"
    glossary_review_no_selection: str = "No entries selected for review"
    glossary_review_done: str = "Glossary Review Complete"
    glossary_review_results_title: str = "Glossary Review Results"
    glossary_review_keep: str = "Keep"
    glossary_review_fix: str = "Fix"
    glossary_review_remove: str = "Remove"
    glossary_review_apply: str = "Apply Changes"
    glossary_review_discard: str = "Discard"
    glossary_review_applied: str = "Glossary review changes applied"
    review_page_history: str = "History"
    review_page_history_undo: str = "Undo"
    review_page_history_redo: str = "Redo"
    review_page_history_save: str = "Save"
    review_page_history_empty: str = "No reviewed lines yet"
    review_page_history_undo_success: str = "Reverted translation for re-review"
    review_page_history_redo_success: str = "Re-applied translation fix"
    review_page_history_save_success: str = "Saved {COUNT} line(s) to project"
    review_page_filter_all: str = "All"
    review_page_filter_pass: str = "Pass"
    review_page_filter_fix: str = "Fixed"
    review_page_filter_fail: str = "Fail"
    review_page_filter_error: str = "Error"
    review_page_auto_retry_failed: str = "Auto Retry Failed Lines"
